               ...
               <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                  ...
                  <div className="flex items-center gap-3 self-end md:self-center">
                     <Link href={`${workspaceBase}/admission/print/${app.id}`} target="_blank">
                        <Button variant="outline" size="sm" className="rounded-xl font-bold border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 dark:text-white">
                     ...
                     <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="rounded-2xl p-2 min-w-[160px] shadow-2xl border-none ring-1 ring-slate-100 dark:ring-slate-800 bg-white dark:bg-slate-900">
                           <DropdownMenuItem 
                              className="rounded-xl cursor-pointer font-bold text-emerald-600 focus:text-emerald-600 focus:bg-emerald-50 dark:focus:bg-emerald-500/10 py-2.5"
                              onClick={() => handleStatusUpdate(app.id, "APPROVED")}
                           >
                              <CheckCircle className="mr-2 h-4 w-4" /> Approve Applicant
                           </DropdownMenuItem>
                           <DropdownMenuItem 
                              className="rounded-xl cursor-pointer font-bold text-red-600 focus:text-red-600 focus:bg-red-50 dark:focus:bg-red-500/10 py-2.5"
